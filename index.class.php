 ...
 * directory defined as the namespace's core path.  I'm breaking all the rules here by handing off
 * all manager requests to my own classes (see the BaseController.php).
 *
 * I'm overriding a fair number of the modExtraManagerController functions there to support
 * custom routing within the manager.  By overriding the getInstance() method I am abandoning 
