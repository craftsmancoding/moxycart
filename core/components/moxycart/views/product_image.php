<li class="li_product_image" id="product-image-<?php print $data['image_id']; ?>">
	<div class="img-info-wrap">
	    <a class="edit-img" href="?a=<?php print $data['action'] ?>&f=image_update&image_id=<?php print $data['image_id']; ?>" data-image_id="<?php print $data['image_id']; ?>" data-toggle="modal" data-target="#update-image">
