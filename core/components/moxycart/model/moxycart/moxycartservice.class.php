 ...
 */
/**
 * The base service class for Moxycart.
 *
 * @package moxycart
 */
class MoxycartService {
    /**
    ...
    /**
     * Create an instance of MoxycartService.
     *
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $corePath = $this->modx->getOption('moxycart.core_path',$config,$this->modx->getOption('core_path').'components/moxycart/');
        $assetsUrl = $this->modx->getOption('moxycart.assets_url',$config,$this->modx->getOption('assets_url').'components/moxycart/');
