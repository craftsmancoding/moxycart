...
Moxycart.page.CreateArticle = function(config) {
    ...
    Moxycart.page.CreateArticle.superclass.constructor.call(this,config);
};
Ext.extend(Moxycart.page.CreateArticle,MODx.page.CreateResource,{

});
Ext.reg('moxycart-page-article-create',Moxycart.page.CreateArticle);
