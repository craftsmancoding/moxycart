...
Moxycart.page.UpdateArticle = function(config) {
    ...
    Moxycart.page.UpdateArticle.superclass.constructor.call(this,config);
};
Ext.extend(Moxycart.page.UpdateArticle,MODx.page.UpdateResource,{
...
Ext.reg('moxycart-page-article-update',Moxycart.page.UpdateArticle);



Moxycart.panel.Article = function(config) {
    config = config || {};
    Ext.applyIf(config,{
    });
    Moxycart.panel.Article.superclass.constructor.call(this,config);
};
Ext.extend(Moxycart.panel.Article,MODx.panel.Resource,{
    getFields: function(config) {
        var it = [];
        it.push({
            title: _('moxycart.article')
        ...
        /*
        it.push({
            title: _('moxycart.statistics')
            ,autoHeight: true
            ,items: [{
                html: _('moxycart.statistics.intro_msg')
                ,border: false
                ,bodyCssClass: 'panel-desc'
            },{
                xtype: 'panel'
    ...
    ,getMainLeftFields: function(config) {
        ...
        var mlf = [{
            xtype: 'textfield'
            ,fieldLabel: _('moxycart.article_title')+'<span class="required">*</span>'
            ,description: '<b>[[*pagetitle]]</b><br />'+_('moxycart.article_title_help')
            ,name: 'pagetitle'
        ...
        if (MODx.config['moxycart.article_show_longtitle']) {
            mlf.push({
                xtype: 'textfield'
        ...
        mlf.push({
            xtype: 'textarea'
            ,fieldLabel: _('moxycart.article_summary')
            ,description: '<b>[[*introtext]]</b><br />'+_('moxycart.article_summary')
            ,name: 'introtext'
    ...
    ,getContentField: function(config) {
        return [{
            ...
            xtype: 'textarea'
            ,fieldLabel: _('moxycart.article_content')
            ,name: 'ta'
            ,id: 'ta'
            ,anchor: '100%'
            ,height: 400
    ...
    ,getMainRightFields: function(config) {
        ...
        return [{
            xtype: 'fieldset'
            ,title: _('moxycart.publishing_information')
            ,id: 'moxycart-box-publishing-information'
            ,defaults: {
                msgTarget: 'under'
            }
            ,items: [{
                xtype: 'moxycart-combo-publish-status'
                ,id: 'modx-resource-published'
                ,name: 'published'
                ,hiddenName: 'published'
                ,fieldLabel: _('moxycart.status')
            },{
                xtype: 'xdatetime'
            ...
            xtype: 'fieldset'
            ,title: _('moxycart.article_options')
            ,id: 'moxycart-box-options'
            ,defaults: {
                msgTarget: 'under'
            }
            ,items: [{
                ...
                xtype: 'textfield'
                ,fieldLabel: _('moxycart.article_alias')
                ,description: '<b>[[*alias]]</b><br />'+_('moxycart.article_alias_help')
                ,name: 'alias'
                ...
                xtype: 'textfield'
                ,fieldLabel: _('moxycart.article_tags')
                ,description: _('moxycart.article_tags_help')
                ,name: 'tags'
...
Ext.reg('modx-panel-article',Moxycart.panel.Article);