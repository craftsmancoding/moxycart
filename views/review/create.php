...
<div class="moxycart_canvas_inner">
    <h2 class="moxycart_cmp_heading">Create New Review</h2>
</div>

<div class="x-panel-body panel-desc x-panel-body-noheader x-panel-body-noborder"><p>Here you can Create New Review.</p></div>
